    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers(HttpMethod.POST, "/v1/api/auth-service/login").permitAll()
                        .requestMatchers(HttpMethod.POST, "/v1/api/auth-service/register").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/tarefas").hasAuthority("ADMIN")
